export declare const graph: import("@langchain/langgraph").CompiledStateGraph<{
    query: string;
    webSearchResults: import("@opencanvas/shared/types").SearchResult[];
    ...
    shouldSearch?: boolean | undefined;
    ...
    classifyMessage: Partial<import("@langchain/langgraph").StateType<{
        query: {
            (): import("@langchain/langgraph").LastValue<string>;
            (annotation: import("@langchain/langgraph").SingleReducer<string, string>): import("@langchain/langgraph").BinaryOperatorAggregate<string, string>;
            Root: <S extends import("@langchain/langgraph").StateDefinition>(sd: S) => import("@langchain/langgraph").AnnotationRoot<S>;
    ...
    queryGenerator: Partial<import("@langchain/langgraph").StateType<{
        query: {
            (): import("@langchain/langgraph").LastValue<string>;
            (annotation: import("@langchain/langgraph").SingleReducer<string, string>): import("@langchain/langgraph").BinaryOperatorAggregate<string, string>;
            Root: <S extends import("@langchain/langgraph").StateDefinition>(sd: S) => import("@langchain/langgraph").AnnotationRoot<S>;
